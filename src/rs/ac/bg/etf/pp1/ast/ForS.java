...
public class ForS extends Statement {
    ...
    public ForS (DesignatorStatementOption DesignatorStatementOption, ConditionOption ConditionOption, DesignatorStatementOption DesignatorStatementOption1, Statement Statement) {
